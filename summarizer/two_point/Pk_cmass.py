"""
Lucia's goals/thinkings: instead of Matt having this own little code in the cmass directory,
make it so the summarizer can be called
First: simplifying the 'tools_cmass.py' code to include the survey/tools.py and sumamries/tools.py functions together
Second: added the utils.py stuff from cmass/utils to summarizer's utils/
so now... this should be a copy of the Pk_cmass code from Matt's cmass stuff, just put into summarizer

On infinity, the cmass code has a few HOD examples here: /home/mattho/git/ltu-cmass/data/pmwd/L3000-N384/3/obs
...
print('loaded all imports correctly')
...
#^ this is what gives cfg for later steps, using yamls! 
